...
LD_LIBRARY_PATH=/usr/lib32:/storage/opt/mupen64plus/lib32 /storage/opt/mupen64plus/mupen64plus --resolution 640x480 --plugindir /storage/opt/mupen64plus --gfx mupen64plus-video-rice.so --corelib /storage/opt/mupen64plus/libmupen64plus.so.2 --datadir /storage/opt/mupen64plus "$1"
elif [[ $3 == "mupen64plus-sa-glide64mk" ]]; then
LD_LIBRARY_PATH=/usr/lib32:/storage/opt/mupen64plus/lib32 /storage/opt/mupen64plus/mupen64plus --resolution 640x480 --plugindir /storage/opt/mupen64plus --gfx mupen64plus-video-glide64mk2.so --corelib /storage/opt/mupen64plus/libmupen64plus.so.2 --datadir /storage/opt/mupen64plus "$1"
